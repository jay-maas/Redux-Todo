            ...
            return ( <
                > {
                    this.props.todos && this.props.todos.map(todo => ( <
                        div className = "Todo"
                        onMouseEnter = {
                            () => document.getElementById(`${todo.id}`).style.display = "initial"
                        }
                        onMouseLeave = {
                    ...
                    placeholder = "Add New Todo" /
                        ...
                        /div> : <><p style={{fontSize: '1em', width: '75%', textShadow: 'none', filter: 'invert(1)', fontWeight: '800'}}>You can only have 3 todos on this app, because you are at the beach, and you should relax...Try completing all your todos or deleting them!</p > < img style = {
                            {
                                position: 'absolute',
                                left: '0',
                                bottom: '0',
